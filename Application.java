...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        students.add(new StudentClass("Женя", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС), НБ"));
        students.add(new StudentClass("Андрей", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС)"));
        students.add(new StudentClass("Сергей", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС), НБ, ПДО"));
        students.add(new StudentClass("Саша", "ДД, ПДД, СОП(КС), СОП(ДС), НБ"));
        students.add(new StudentClass("Максим", "ДД, ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Стас", "ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Роман", "ПДД, СОП(КС), СОП(ДС), КСП, ОСП"));
